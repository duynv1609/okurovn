            ...
            <div id="Utilities" className="flex justify-center h-full">
                ...
                >
                    ...
                    {/* <img
                        ...
                        alt="image 2"
                        className="h-full p-20 w-full object-cover"
                    />
                    <img
            ...
            <div className="h-[1000px] w-full  ">
                <div className="flex flex-col items-center justify-center">
                    <div className="flex h-[70px]  w-full items-center justify-center">
                        <p className="text-okuro-color-text capitalize text-center font-roboto text-4xl font-black leading-[32px]">
                                ...
                                <div
                                    className={clsx(
                                        "absolute   left-1/2 bg-white  -translate-x-[50%] z-50 flex w-[1271px] gap-[24px]",
                                        {
                                            ...
                                            "-translate-x-[108.22%]": activeIndex == 10,
                                            "-translate-x-[122.77%]": activeIndex == 11,
                                        }
                                    )}
                                >
                                    ...
                                    >
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Mạng lưới kết nối{" "}
                                                <span className="text-okuro-web-text">thông tin giá trị và</span> tương
                                                tác đa chiều
                                            </span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Không gian chia sẻ{" "}
                                                <span className="text-okuro-web-text">
                                                    giữa phụ huynh trong hành trình nuôi dạy con khỏe mạnh thông minh
                                                </span>
                                            </span>
                                        </li>
                                        <li>
                                ...
                                <div className="flex flex-col gap-4 justify-start items-start h-full w-full ">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Tổng hợp và sắp xếp{" "}
                                                <span className="text-okuro-web-text">các trường thông tin tối ưu</span>
                                            </span>
                                        </li>
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                    ...
                                    >
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Cập nhật thông tin{" "}
                                                <span className="text-okuro-web-text">
                                                    thời gian và chất lượng bữa ăn hàng ngày: bữa sáng, bữa trưa và bữa
                                                    phụ
                                                </span>
                                            </span>
                                        </li>
                                    ...
                                    >
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Cập nhật hoạt động{" "}
                                                <span className="text-okuro-web-text">
                                                    theo thời gian thực của học sinh trong suốt quá trình sinh hoạt tại
                                                    trường
                                                </span>
                                            </span>
                                        </li>
                                ...
                                <div className="flex flex-col gap-4 justify-start items-start h-full w-full ">
                                    ...
                                    >
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Giao diện hiển thị{" "}
                                                <span className="text-okuro-web-text"> dưới định dạng lịch cụ thể</span>
                                            </span>
                                        </li>
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Hệ thống{" "}
                                                <span className="text-okuro-web-text">
                                                    quản lý, thống kê và đánh giá tình hình hoạt động của các lớp học
                                                </span>
                                            </span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                Tiết kiệm thời gian{" "}
                                                <span className="text-okuro-web-text">
                                                    cho giáo viên và phụ huynh trong việc quản lý quá trình học tập của
                                                    học sinh
                                                </span>
                                            </span>
                                        </li>
                            ...
                            <div className="flex w-full   h-[642px] p-20 gap-20">
                                ...
                                <div className="flex flex-col gap-4 justify-start items-start h-full w-full ">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <span className="text-xl font-roboto font-normal leading-[170%] text-okuro-orange">
                                                <span className="text-okuro-web-text">Hệ thống lưu trữ </span> hóa đơn
                                                điện tử
                                            </span>
                                        </li>
                                        <li>
